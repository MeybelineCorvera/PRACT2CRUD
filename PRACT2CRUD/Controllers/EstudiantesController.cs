...
namespace PRACT2CRUD.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Carnet,Genero,IdAsignatura")] Estudiantes estudiantes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Carnet,Genero,IdAsignatura")] Estudiantes estudiantes)
        {
